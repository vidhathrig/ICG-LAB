...
function main() {
  ...
  const texture1 = loadTexture(gl, 'tex1.jpeg');
  const texture2 = loadTexture(gl, 'tex2.jpg');
  const texture3 = loadTexture(gl, 'tex3.jpeg');
  const texture4 = loadTexture(gl, 'tex4.jpeg');
  const texture5 = loadTexture(gl, 'tex5.jpg');
  const texture6 = loadTexture(gl, 'tex6.jpeg');
